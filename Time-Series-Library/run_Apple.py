...
WHICH_MODEL = 'iTransformer' #'TimesNet' or 'iTransformer' or 'TimeXer'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='Apple_Dataset.csv', help='data file')
    ...
    # Augmentation
    parser.add_argument('--augmentation_ratio', type=int, default=5, help="How many times to augment")
